...
Compare with [[https://github.com/joshcho/ChatGPT.el.git][joshcho/ChatGPT.el]], this repo support stream reply, and make the output more pretty, the repo is inspiration by [[https://github.com/carlos-wong/ChatGPT.el.git][carlos-wong/ChatGPT.el]]
I add chatgpt-query-stream and chatgpt-query-by-type-stream, and change the default python dependency into revChatGPT to use the official API.
...
*** OpenAI key
you should store your openai's key into ~/.authinfo.gpg in this format:
#+begin_src conf
